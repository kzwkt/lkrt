...
void print_usage(int status)
{
    printf("Usage: %s [option] ... [command] ...\n"
           "\n%s\n"
           "\n  -d, --device     manually specify a device"
           "\n  -e, --exploit    manually specify an exploit"
           "\n  -h, --help       display this help and exit"
           "\n  -k, --kernel     manually specify kernel version"
           "\n  -l, --list       list available devices and exploits"
